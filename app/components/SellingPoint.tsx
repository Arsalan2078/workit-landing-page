...
export default function SellingPoint({
  ...
  return (
    <div className="flex flex-col items-center gap-300 md:flex-row md:gap-700 lg:flex-col">
      ...
      <div className="flex flex-col items-center gap-200 text-center md:items-start md:gap-350 md:text-start lg:items-center lg:text-center">
        <h3>{heading}</h3>
        <p>{paragraph}</p>
      </div>
    </div>
